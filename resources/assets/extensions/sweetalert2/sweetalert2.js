...
(function (global, factory) {
     ...
     */
    var getDirectChildByClass = function getDirectChildByClass(
        elem,
        className
    ) {
     ...
     * @returns {SweetAlertOptions}
     */
    var getSwalFunctionParams = function getSwalFunctionParams(
        templateContent
    ) {
        var result = {};
        /** @type {HTMLElement[]} */
        ...
        _createClass(SweetAlert, [
            {
                ...
                value: function _main(userParams) {
                    ...
                    showWarningsForParams(
                        Object.assign({}, mixinParams, userParams)
                    );
            ...
            },
            {
                ...
                value: function then(onFulfilled) {
                    return _classPrivateFieldGet2(_promise, this).then(
                        onFulfilled
                    );
                },
            },
            {
                ...
                value: function _finally(onFinally) {
                    return _classPrivateFieldGet2(_promise, this)["finally"](
                        onFinally
                    );
                },
            },
